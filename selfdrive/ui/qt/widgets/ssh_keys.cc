...
SshControl::SshControl() : ButtonControl("SSH 키", "", "경고: 이 경우 GitHub 설정의 모든 공개 키에 SSH 액세스 권한이 부여됩니다. 자신의 GitHub 사용자 이름이 아닌 다른 사용자 이름을 입력하지 마십시오. comma 직원은 GitHub 사용자 이름 추가를 절대로 요구하지 않습니다.") {
  ...
  QObject::connect(this, &ButtonControl::clicked, [=]() {
    if (text() == "ADD") {
      QString username = InputDialog::getText("GitHub 사용자 이름을 입력하세요.", this);

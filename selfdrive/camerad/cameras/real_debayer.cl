                       ...
                       )
{
  ...
  rgb_out[0] = color_correct(clamp(rgb, 0.0, 1.0));
  ...
  rgb_out[1] = color_correct(clamp(rgb, 0.0, 1.0));
  ...
  rgb.z = vc.s1; // B
  rgb_out[2] = color_correct(clamp(rgb, 0.0, 1.0));
  ...
  rgb_out[3] = color_correct(clamp(rgb, 0.0, 1.0));
